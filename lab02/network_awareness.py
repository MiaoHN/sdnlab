...
class NetworkAwareness(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.echo_thread = hub.spawn(self._get_echo)
        self.rtt = {}
        self.echo_delay = {}
        self.lldp_delay = {}
        self.switches = None
    ...
    def get_delay(self, src, dst):
        try:
            ...
            dela = (lldp12 + lldp21 - echo1 - echo2) / 2
            return max(dela, 0)
        except:
            return float('inf')
    ...
    def _get_topology(self):
        ...
        while True:
            ...
            for link in links:
                ...
                if (link.src.dpid, link.dst.dpid) not in self.rtt:
                    self.rtt[(link.src.dpid, link.dst.dpid)] = 1
                self.topo_map.add_edge(
